...
`r MaxStepsInterval` is the time interval with the highest daily average of steps.
...
```
There are `r Missing` rows where the steps is missing.


2. Devise a strategy for filling in all of the missing values in the dataset. 

THe Imputed data will have the Null values replaced with the mean of all steps (`r mean(Activity$steps,na.rm = TRUE)`)
...
Variance of Mean: `r MeanVariance`

Varianace of Median: `r MedianVariance`
